...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repositories/list",
...
async def hacs_repositories_list(
    ...
    if hacs is None:
        # Optionally, send an error message or handle gracefully
        return
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repositories/clear_new",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repositories/removed",
    }
)
@websocket_api.require_admin
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repositories/add",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repositories/remove",
        vol.Required("repository"): cv.string,
    }
)
@websocket_api.require_admin
