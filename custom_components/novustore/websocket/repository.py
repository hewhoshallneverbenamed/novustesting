...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repository/info",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repository/ignore",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repository/state",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repository/version",
        vol.Required("repository"): cv.string,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repository/beta",
        vol.Required("repository"): cv.string,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repository/download",
        vol.Required("repository"): cv.string,
...
async def hacs_repository_download(
    ...
    if repository is None:
        hacs.log.error(f"hacs_repository_download: repository is None for id={msg['repository']}")
        connection.send_error(msg["id"], "repository_not_found", f"Repository with ID ({msg['repository']}) not found")
        return
    ...
    try:
        ...
        hacs.log.error(f"hacs_repository_download: HacsException {exception}")
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repository/remove",
        vol.Required("repository"): cv.string,
    }
)
@websocket_api.require_admin
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repository/refresh",
        vol.Required("repository"): cv.string,
    }
)
@websocket_api.require_admin
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repository/release_notes",
        vol.Required("repository"): cv.string,
    }
)
@websocket_api.require_admin
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "novustore/repository/releases",
